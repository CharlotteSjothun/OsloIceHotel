 ...
 * 
 * Klassen er subklasse av HotelRoom og representerer et enkeltrom i programmet.
 */
...
public class SingleRoom extends HotelRoom
{
    ...
    public SingleRoom(String roomType, int nr, int nrOfBedsp, String bedTypes, int pri)
    {
